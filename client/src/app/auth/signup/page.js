    ...
    return (
        <div className="flex w-screen h-screen items-center justify-center bg-primaryBlue font-inter">
            <section className="rounded-3xl bg-white flex flex-col gap-8 w-1/3 p-8 px-12">
                <h1 className={`font-semibold text-2xl text-center text-primaryBlack mt-4`}>Create Account</h1>

                <section className="flex flex-col text-primaryBlack gap-4">
                    <label className="flex flex-col gap-1">
                        <span className="font-medium">Name</span>
                        <input type="text" className=" focus:outline-primaryBlue transition-all border-2 border-gray-300 px-4 p-2 rounded-md" />
                    </label>
                    <label className="flex flex-col gap-1">
                ...
                <p className="text-center font-medium">Already have an account? <Link href="/auth/login" className="text-primaryBlue mx-1 hover:underline">Login</Link></p>
            </section>
        </div>
    )
}